...
2. Response in Markdown formatting:
  ...
  - All non-code responses should respect the language the user prefers.
  - All code responses should respect the original spoken language used in comments and text elements within the user provided codes.
