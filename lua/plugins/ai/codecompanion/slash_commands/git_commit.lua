...
4. After generating commit messages, stage diffs and then commit them. If there'are multiple lines to commit, commit them with `git commit -F- <<EOF`. Make sure that you properly escape the backticks in the commit message.
]]
